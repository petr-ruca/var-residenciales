...
for filez in filename:
    ...
    if num_linestxt == num_linescsv:
        messagebox.showinfo("CARL SAGAN:", "El archivo y su respectivo .TXT " + str(filez) + " tienen el mismo numero de filas! En concreto: " + str(num_linescsv))
    else:
        messagebox.showinfo("CARL SAGAN:", "Algo ha ido mal, los archivos " + str(filez) + " no tienen el mismo numero de filas..")
